...
class cARCPlayer
{
	...
	*/
    ...
    void reset()
    {
        ...
        // Reset dash speed to default from the UP_DASH upgrade.
        Client @client = @G_GetClient(cliNum);
        client.set_pmoveDashSpeed(450);
    }
    ...
    void spawn()
    {
        // restore dash speed if you have UP_DASH
        if (upgrade == UP_DASH){
            // Reset dash speed to default from the UP_DASH upgrade.
            Client @client = @G_GetClient(cliNum);
            client.set_pmoveDashSpeed(600);
        }
    }
    ...
    {
        // Reset dash speed to default from the UP_DASH upgrade.
        Client @client = @G_GetClient(this.cliNum);
        client.set_pmoveDashSpeed(450);
